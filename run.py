...
if __name__ == '__main__':
    ...
    autoencoder = AutoEncoder(toy_cone)
    
    autoenctrainer=AutoEncoderTrainer(train_loader,val_loader,toy_cone,autoencoder,config.working_dir)
    #autoenctrainer.checkShapes()
    #autoenctrainer.plot2D_oneslice()
    ...
    trainer = Trainer(config, model, criterion, optimizer, toy_cone, autoenctrainer)
